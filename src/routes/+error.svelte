...
<svelte:head>
	<title>{page.status} | National Aquatic Connectivity Collaborative</title>
</svelte:head>

{#if page.status === 404}
	<div class="relative flex-auto w-[100%]">
		<div class="hidden md:block absolute top-0 bottom-0 left-0 right-0 overflow-hidden">
			<enhanced:img
				...
				class="brightness-80"
			/>
			<div class="relative right-0 flex items-end justify-end mt-[-1.75rem]">
				<div class="bg-black/65 text-white py-1 px-2 text-sm">
					Photo:
					<a
